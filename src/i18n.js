            ...
            es: {
                translation: {
                    ...
                    detail: {
                        ...
                        booking_hotel: "Hotel Nombre / zona",
                        booking_hotel_placeholder: "Ej: Maya Ubud Resort, Ubud",
                        ...
                        exp_economy_sub: "",
                        exp_economy_desc: "Explora a tu ritmo con un conductor local de total confianza, quien se encargará de la ruta y el tráfico, mientras tú exploras la isla con absoluta libertad.",
                        exp_economy_price_label: "",
                        exp_comfort_title: "Guía Local (Idioma Inglés)",
                        exp_comfort_sub: "",
                        exp_comfort_desc: "Viaja cómodo y acompañado por un guía local certificado en inglés. Descubre la historia profunda de la isla. Tu guía te ayudará además a tomar las mejores fotos de tu viaje.",
                        exp_comfort_price_label: "",
                        exp_elite_title: "Guía Local (Idioma Español)",
                        exp_elite_sub: "",
                        exp_elite_desc: "Nuestra experiencia estrella: guía local certificado, 100% en español. Explicaciones históricas profundas, sin barreras de idioma. Tu guía te ayudará además a tomar las mejores fotos de tu viaje.",
                        exp_elite_warning: "",
                        ...
                        fair_payment_desc: "Tu reserva te permite abonar el 100% hasta 48h antes del tour. Con este sistema aseguramos un compromiso justo para el equipo local desde el primer minuto, fomentando un turismo responsable y que apoya directamente a las familias de Bali.",
                    ...
                    reviews_page: {
                        ...
                        description: "Tu opinión transparente es vital para nuestro equipo. Te tomará menos de 1 minuto.",
                        form: {
                            next: "Siguiente",
                            back: "Atrás",
                            next_rating: "Valoración Final",
                            step2_title: "¡Genial {{name}}! Evalúa los detalles",
                            error_submit: "Error al enviar. Inténtalo de nuevo.",
                            min_length_error: "El comentario debe tener al menos 10 caracteres.",
                            min_length_hint: "Por favor, escribe al menos 10 caracteres para poder enviar.",
                            welcome_back: "¡Hola {{name}}! Cuéntanos sobre tu experiencia en el tour {{tour}} con tu conductor {{driver}}.",
                            welcome_back_no_driver: "¡Hola {{name}}! Cuéntanos sobre tu experiencia en el tour {{tour}}.",
                            name: "Tu nombre",
                            ...
                            comment_placeholder: "Describe tu experiencia: ¿Qué fue lo mas memorable? ¿Como fue el guia? ¿Que recomendearias a otros viajeros?",
            ...
            en: {
                translation: {
                    ...
                    detail: {
                        ...
                        booking_hotel: "Hotel Name / Zone",
                        booking_hotel_placeholder: "e.g., Maya Ubud Resort, Ubud",
                        ...
                        exp_economy_sub: "",
                        exp_economy_desc: "Explore Bali at your own pace with a trusted local driver who manages the route and traffic, while you discover the island with absolute freedom.",
                        exp_economy_price_label: "",
                        exp_comfort_title: "Local Guide (English Language)",
                        exp_comfort_sub: "",
                        exp_comfort_desc: "Travel comfortably in a superior vehicle accompanied by a certified English guide. Discover the deep history of temples and capture the best photos.",
                        exp_comfort_price_label: "",
                        exp_elite_title: "Local Guide (Spanish Language)",
                        exp_elite_sub: "",
                        exp_elite_desc: "Our flagship experience: 100% Spanish native guide and superior vehicle. Deep historical storytelling, zero language barriers, and helper for the best photos.",
                        exp_elite_warning: "",
                        exp_elite_price_label: "",
                        price_special: "From",
                        ...
                        fair_payment_desc: "Your booking allows you to pay 100% up to 48h before the tour. With this system, we ensure a fair commitment for the local team from minute one, fostering responsible tourism that directly supports Balinese families.",
                    ...
                    reviews_page: {
                        ...
                        description: "Your transparent opinion is vital to our team. It will take you less than 1 minute.",
                        form: {
                            next: "Next",
                            back: "Back",
                            next_rating: "Final Rating",
                            step2_title: "Great {{name}}! Let's evaluate the details",
                            error_submit: "Failed to submit. Please try again.",
                            min_length_error: "The comment must be at least 10 characters long.",
                            min_length_hint: "Please write at least 10 characters to submit.",
                            welcome_back: "Hi {{name}}! Tell us about your experience on the {{tour}} tour with your driver {{driver}}.",
                            welcome_back_no_driver: "Hi {{name}}! Tell us about your experience on the {{tour}} tour.",
                            name: "Your name",
                            ...
                            comment_placeholder: "Describe your experience: What was the most memorable moment? How was the guide? What would you recommend to other travelers?",
