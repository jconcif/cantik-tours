            ...
            es: {
                translation: {
                    ...
                    detail: {
                        ...
                        exp_economy_sub: "",
                        exp_economy_desc: "Muévete por Bali con un conductor local de total confianza. Él se encarga de la ruta y el tráfico mientras tú exploras la isla con absoluta libertad.",
                        exp_economy_price_label: "",
                        exp_comfort_title: "Guía Local (Idioma Inglés)",
                        exp_comfort_sub: "",
                        exp_comfort_desc: "Viaja cómodo en un vehículo superior acompañado por un guía certificado en inglés. Conoce las leyendas de cada templo y la verdadera esencia de la isla de los dioses. Tu guía te ayudará además a tomar las mejores fotos de tu viaje.",
                        exp_comfort_price_label: "",
                        exp_elite_title: "Guía Local (Idioma Español)",
                        exp_elite_sub: "",
                        exp_elite_desc: "Nuestra experiencia estrella. Acompañamiento premium con un guía oficial nativo 100% en español. Sin barreras, con explicaciones históricas profundas y un coche superior. Tu guía te ayudará además a tomar las mejores fotos de tu viaje.",
                        exp_elite_warning: "",
            ...
            en: {
                translation: {
                    ...
                    detail: {
                        ...
                        exp_economy_sub: "",
                        exp_economy_desc: "Move around Bali with a trusted local driver who manages the route and traffic, while you explore the island with absolute freedom.",
                        exp_economy_price_label: "",
                        exp_comfort_title: "Local Guide (English Language)",
                        exp_comfort_sub: "",
                        exp_comfort_desc: "Travel in a superior vehicle accompanied by a certified English-speaking guide. Discover the legends behind each temple and the true essence of Bali. Your guide will also assist in capturing the best photos of your trip.",
                        exp_comfort_price_label: "",
                        exp_elite_title: "Local Guide (Spanish Language)",
                        exp_elite_sub: "",
                        exp_elite_desc: "Our signature experience. Premium service with an official native guide 100% in Spanish. Deep historical storytelling, zero language barriers, and a superior vehicle. Your guide will also assist in capturing the best photos of your trip.",
                        exp_elite_warning: "",
                        exp_elite_price_label: "",
                        price_special: "From",
